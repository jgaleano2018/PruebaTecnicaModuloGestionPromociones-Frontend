export function validatePromotion(form) {
  ...
  if (
    form.valorDescuento != null &&
    form.valorDescuento !== '' &&
    !/^\d{1,16}(\.\d{1,2})?$/.test(
      String(form.valorDescuento),
    )
  ) {
    errors.valorDescuento =
      'Usa un decimal con máximo 2 decimales'
  }
